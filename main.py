"""
Code Reviewer — Senior engineer feedback on any code snippet
...
SYSTEM_PROMPT = "You are an expert Code Reviewer assistant. Paste code and get a thorough review covering bugs, security issues, performance, and style \u2014 like having a senior engineer on demand."
...
<div id="auth-overlay">
  <div class="auth-box">
    ...
    <div class="auth-sub">Senior engineer feedback on any code snippet</div>
    <div class="auth-tabs">
...
<div class="wrap" id="main-app" style="display:none">
  <div class="hero">
    ...
    <h1><em>Code Reviewer</em><br>Senior engineer feedback on any code snippet</h1>
    <p>Paste code and get a thorough review covering bugs, security issues, performance, and style — like having a senior engineer on demand. Built for users.</p>
  </div>
...
const APP = {
  ...
  systemPrompt:   "You are an expert Code Reviewer assistant. Paste code and get a thorough review covering bugs, security issues, performance, and style \\u2014 like having a senior engineer on demand.",
